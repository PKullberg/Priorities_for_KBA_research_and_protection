...
terrestrial_threatened_dd_and_gbif_spp_status <- rbind(terrestrial_threatened_and_dd_spp, GBIF_spp) # leave status for later use
...
terrestrial_threatened_dd_and_gbif0_spp <- bind(terrestrial_threatened_and_dd_spp, GBIF_spp)
terrestrial_threatened_dd0_and_gbif0_spp <- bind(terrestrial_DD0_spp, GBIF_spp)
